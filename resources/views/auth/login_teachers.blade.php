...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Teachers Login') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="teachers_authenticate">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="text" value="staff" class="form-control @error('role') is-invalid @enderror" name="role" required readonly">
