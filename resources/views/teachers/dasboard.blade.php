  ...
  <main>
    ...
    <div class="container d-flex justify-content-between mb-5">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
               <a class="nav-link" href="addcourses">{{Auth::user()->courses}} Exams Attendance List</a>
            </li>
        </ul>
    </div>
    <div class="container pages">
        <div class="row">
            <div class="col">
                ...
                <img src="" alt="">
                <p>Name: <span class="text-uppercase">{{Auth::user()->full_name}}</span></p>
                <p>Role: <span class="text-capitalize">{{Auth::user()->role}}</p>
                <p>Department: <span class="text-capitalize">{{Auth::user()->department}}</p>
