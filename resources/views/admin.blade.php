            ...
            <span class="dropdown-center">
                ...
                <ul class="dropdown-menu">
                    @foreach ($allCourses as $course)
                        <li><a class="dropdown-item" href="">{{$course->course_code}} | {{$course->course_name}} | SOC {{$course->studentsOferringCourse}}</a></li>
                    @endforeach
                </ul>
            </span>
            <span class="dropdown-center">
                ...
                <ul class="dropdown-menu">
                    @foreach ($allHalls as $hall)
                        <li><a class="dropdown-item" href="">{{$hall->hall_name}} | Capacity {{$hall->hall_capacity}}</a></li>
                    @endforeach
                </ul>
            </span>
        </div>
